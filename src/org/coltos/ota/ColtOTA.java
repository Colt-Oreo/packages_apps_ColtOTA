...
public class ColtOTA extends Application {
	...
	public static void putAddonDownload(int key, long value) {
		Log.d("ColtOTA", "Putting Addon with Key: " + key + " and Value: " + value);
		mAddonsDownloads.put(key, value);
	}
	
	public static long getAddonDownload(int key) {
		Log.d("ColtOTA", "Getting Addon with Key: " + key);
